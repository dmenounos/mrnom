...
void RenderView::setUp()
{
	...
	android_app* application = mGameContext->getApplication();
	ANativeWindow* window = application->window;
	...
	mEglSurface = eglCreateWindowSurface(mEglDisplay, config, window, NULL);
